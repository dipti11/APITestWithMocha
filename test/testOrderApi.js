...
describe('POST order api', function() {
  ...
  it('should fail to create order with only one stop', async () => {
  ...
  it('should fail to create order with incorrect co-ordinates', async () => {
  ...
  it('should fail to create order with missing payload', async () => {
    const response = await testData.getRequestURL()
      .post('/v1/orders')
      .set('Content-Type', 'application/json')
      .send('');
...
describe('GET order api', function() {
  ...
  it('should fail to fetch order for incorrect order id', async () => {

    const response = await testData.getRequestURL()
      .get('/v1/orders/' + testData.incorrectOrderId);
...
describe('PUT api for take order', function() {
  ...
  it('should fail to take order for incorrect order id', async () => {

    const response = await testData.getRequestURL()
      .put('/v1/orders/' + testData.incorrectOrderId + '/take');
...
describe('PUT api for complete order', function() {
  ...
  it('should fail to complete order for incorrect order id', async () => {

    const response = await testData.getRequestURL()
      .put('/v1/orders/' + testData.incorrectOrderId + '/complete');
...
describe('PUT api for cancel order', function() {
  ...
  it('should fail to cancel order for incorrect order id', async () => {

    const response = await testData.getRequestURL()
      .put('/v1/orders/' + testData.incorrectOrderId + '/cancel');
